...
- Those memory-color profiles now come from one shared catalog used by Django, the kiosk review UI, and `/ops/`, so the profile list stays aligned across storage, playback, and operator visibility
