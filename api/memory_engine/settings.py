...
PRESENCE_SENSING_ENABLED = env_bool("PRESENCE_SENSING_ENABLED", False)
OPS_PRESENCE_HEARTBEAT_MAX_AGE_SECONDS = env_int("OPS_PRESENCE_HEARTBEAT_MAX_AGE_SECONDS", 20)
PRESENCE_CAMERA_DEVICE = os.getenv("PRESENCE_CAMERA_DEVICE", "/dev/video0").strip()
PRESENCE_FRAME_WIDTH = env_int("PRESENCE_FRAME_WIDTH", 640)
PRESENCE_FRAME_HEIGHT = env_int("PRESENCE_FRAME_HEIGHT", 360)
PRESENCE_FRAME_INTERVAL_MS = env_int("PRESENCE_FRAME_INTERVAL_MS", 500)
PRESENCE_MOTION_PIXEL_RATIO_THRESHOLD = env_float("PRESENCE_MOTION_PIXEL_RATIO_THRESHOLD", 0.008)
PRESENCE_MOTION_MIN_CONTOUR_AREA = env_int("PRESENCE_MOTION_MIN_CONTOUR_AREA", 1200)
