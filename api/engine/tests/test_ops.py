...
class OperatorBehaviorTests(EngineTestCase):
    ...
    def test_operator_dashboard_lite_and_bench_render_after_session_login(self):
        ...
        self.assertContains(lite, "Top state")
        self.assertContains(lite, "Fast safety controls stay visible")
        self.assertContains(lite, "Evidence chips")
        self.assertContains(lite, "Open Room")
        self.assertContains(lite, "Run Room")
        self.assertContains(lite, "Fix Problem")
        self.assertContains(lite, "Close Session")
        self.assertContains(lite, "Clear session framing")
        self.assertContains(lite, "Session close archive command")
